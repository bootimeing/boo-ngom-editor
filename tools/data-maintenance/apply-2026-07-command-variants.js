...
const variants = {
  ...
  OPENMERCHANTBIGDLG: {
    GOM: {
      ...definition(
        'OPENMERCHANTBIGDLG WIL 图片或图片|1|目标宽|目标高 [可移动] [位置] [偏移X] [偏移Y] [显示关闭] [关闭X] [关闭Y] [独立窗口]',
        ['WIL', '图片或九宫格(图片|1|目标宽|目标高)', '[可移动(0/1)]', '[位置(0-4)]', '[偏移X]', '[偏移Y]', '[显示关闭(0/1)]', '[关闭X]', '[关闭Y]', '[独立窗口:0否/1是]'],
        '打开GOM NPC大对话框；图片参数支持图片|1|目标宽|目标高九宫格，参数10控制是否与普通对话框共存'
      ),
      minArgs: 2,
      maxArgs: 10,
    },
